...
public class ExpressionLLVM : Expression {
    ...
    public override LLVMValueRef Compile(LLVMModuleRef mod, LLVMBuilderRef builder) {
        ...
        switch (Instruction) {
            ...
            case "call":
                return builder.BuildCall2(args[0].TypeOf, args[0], args.ToList().GetRange(1, args.Length - 1).ToArray());
            case "extractelement":
                VerifyArgs(2);
            ...
            case "gep":
                return builder.BuildGEP2(args[0].TypeOf, args[0], args.ToList().GetRange(1, args.Length - 1).ToArray());
            case "icmpeq":
                VerifyArgs(2);
            ...
            case "load":
                VerifyArgs(1);
                return builder.BuildLoad2(args[0].TypeOf, args[0]);
            case "lshr":
                VerifyArgs(2);
